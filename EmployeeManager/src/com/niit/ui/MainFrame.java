...
public class MainFrame extends JFrame {
	...
	public void loadData(){
		...
		for(int i = 0; i< emps.size(); i++){
			...
			//构造该员工的数组
			empObj[i] = new Object[]{emp.getEmpId(),emp.getEmpName(),emp.getSalary()+"",emp.getHireDate()+"",jobName,depName,magName,false};
			//empObj[i] = new Object[]{emp.getEmpId(),emp.getEmpName(),emp.getSalary()+"",emp.getHireDate()+"",emp.getJobId()+"",emp.getDepId()+"",emp.getMagId()+"",false};
		}
		//重新绑定表格数据
